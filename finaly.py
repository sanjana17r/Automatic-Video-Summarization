...
#'BFZtNN6eNvQ'
#link2 = "https://www.youtube.com/watch?v=BFZtNN6eNvQ"
...
#Writing all transcripts in json format
...
#strr=('.'.join(read1['text'].tolist()))
with open('srt_filet1.txt','w',encoding='utf-8') as f:
    count=0
    for i in strr:
        count+=1
        f.write('%s.\n\n' %i) 
#print("Toatal count of subtitle is ",count)
LANGUAGE = "english"
SENTENCES_COUNT = 10
